...
namespace BlueprintReality.MixCast
{
    ...
    public class UpdateChecker
    {
        ...
        static IEnumerator CheckForUpdates(bool headless)
        {
            ...
            if(MixCastSdk.IsVersionBLaterThanVersionA(MixCastSdk.VERSION_STRING, www.text) )
            {
            ...
            else if( MixCastSdk.IsVersionBLaterThanVersionA(www.text, MixCastSdk.VERSION_STRING) )
            {
                NextCheckTime = DateTime.UtcNow + new TimeSpan(0, UNCHANGED_COOLDOWN_MINUTES, 0);
